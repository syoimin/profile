...
export interface ResumeDataItem {
  ...
  export const resumeData: ResumeDataItem[] =  [
    {
      skills: ["マネジメント", "プロジェクトマネジメント", "スクラム"],
      title:
        "30名・複数PJのチームリーダー",
      contents: `
      ・プロジェクトマネージャー兼テックリードとして、30名のチームメンバーとその中で稼働している 4 つのプロジェクトの体制管理・メンバー育成・を行う。
      ・各チームにスクラム開発を導入、支援を行いスクラムマスターに対してスクラムのレクチャーを実施。
      ・進捗管理方法やスクラムイベントの重要性や実施方法を教育し、スクラムの運用を支援。
      `,
      thoughts: ``,
      date: "2024年 10月 ~ 2025年 2月",
      link: "",
      member: 30,
      assign: ["教育", "設計・開発", "アーキテクチャ", "スクラム導入支援"],
      scale: "スクラム開発",
      feat: true,
      jobs: ["チームリーダー", "プロジェクトマネージャー"],
    },
    {
